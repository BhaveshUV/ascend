    ...
    return (
        <Suspense fallback={<div>Loading...</div>}>
            <Await resolve={listing}>
                {(listing) => {
                    return isForm ? <ListingForm listing={listing} setIsForm={setIsForm} /> : <>
                        <div className="m-auto w-full grow flex flex-col md:flex-row cursor-default relative md:min-h-[70vh]">
