...
const ListingCard = ({ listing }) => {
    ...
    return (
        <Link to={`/listings/${_id}`}>
            <div className="max-[551px]:max-w-xs min-[551px]:w-sm min-[736px]:w-xs min-[950px]:w-sm min-[1088px]:w-xs min-[1260px]:w-md grow rounded shadow-2xl bg-[#fedf4b10] cursor-pointer h-full relative">
